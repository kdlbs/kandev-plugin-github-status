module kandev-plugin-github-status
...
// monorepo. See README.md "Developing against the SDK" for the path this
// assumes, and what changes once pkg/pluginsdk ships as its own module.
